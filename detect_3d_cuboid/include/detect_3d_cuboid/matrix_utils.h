...
Eigen::Matrix<T, Eigen::Dynamic, 1> real_to_homo_coord_vec(const Eigen::Matrix<T, Eigen::Dynamic, 1> &pts_in);//输出n*1向量
...
template <class T>//读取text_file_name的内容，并将其存储到Eigen矩阵中
